...
class ProdukController extends Controller
{
	...
	public function index(){
		//kita mengirimkan data kategori yang akan ditampilkan pada pilihan kategori pada form tambah dan edit
		$kategori = Kategori::all();
		return view('produk.index',compact('kategori'));
	}

	public function listData(){
		//untk fungsi list data kita menggunakan server side processing dari plugin dataTable
	...
	public function store(Request $request){
		//method store melakukan pengecekan terlebih dahulu sebelum meyimpan data apakah kode tesb sudah dipakai atau belum
