		...
		<div class="modal-content">
			<form class="form-horizontal" data-toggle="validator" method="post">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="merk" type="text" name="merk" class="form-control" required>
						<span class="help-block with-errors"></span>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input id="harga_jual" type="text" name="harga_jual" class="form-control" required>
						<span class="help-block with-errors"></span>
					</div>
				</div>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary btn-save"><i class="fa fa-floppy-o">Simpan</i></button>
